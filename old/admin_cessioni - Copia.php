...
echo '<div class="p-1 mb-2 text-left h5 bg-light text-white">Conteggio relativo alla cessione del Socio
		<div align="right"><small>vers.Sicra</small></div>
	  </div>
	';
...
$evidenzab = ' style="background-color:#16903C;font-weight:bold;" ';
	...
	echo '<tr><td width="65%">ID2:</td><td>' .$_POST['id2'].'</td></tr>';
	...
	echo '<tr>
			...
			<td>Eur ' .number_format($fondo, 0, ',', '.').'&nbsp;&nbsp;&nbsp;&nbsp;(B)</td></tr>'; 
...
// Somma del valore nominale delle ammissioni negli ultimi 6 mesi
// *****************************************************************************
...
// Calcolo valori
// *****************************************************************************
//$ipotesiBudget		   = 1500 * 33 * 30.33; // 1500 Soci ordinari all'anno
$ipotesiBudgetMensile  = $valore_a / 12 ;
...
$ipotesiBudgetMensile_01_08 = $ipotesiBudgetMensile - ($ipotesiBudgetMensile * 90 / 100) ;
$ipotesiBudgetMensile_10_12 = $ipotesiBudgetMensile - ($ipotesiBudgetMensile * 10 / 100) ;
$BudgetMensile  	 	    = ($ipotesiBudgetMensile_01_08 + $ipotesiBudgetMensile_10_12) / 2 ;

/*
echo 's<br>Ipotesi Budget Mensile '.number_format($ipotesiBudgetMensile,0,'','.')
	 .'<br>Ipotesi Budget 01/08+ '.number_format($ipotesiBudgetMensile_01_08,0,'','.')
	 .'<br>Ipotesi Budget 10/12+ '.number_format($ipotesiBudgetMensile_10_12,0,'','.')
	 .'<br>Ipotesi Budget Mensile'.number_format($BudgetMensile,0,'','.') ;
*/

$rowcount_a = 6;       // i mesi di media sono gli ultimi 6 !!

$nettoDaPagare 	  	   = $importo_totale_cessioni - $fondo ;
	
$ResiduoInMesi		   = round($nettoDaPagare / $BudgetMensile ) ;

	echo '<tr>
			<td>NETTO DA PAGARE </td>
			<td style="color:red;">Eur ' .number_format($nettoDaPagare, 0, ',', '.').'&nbsp;&nbsp;&nbsp;&nbsp;(A - B)</td></tr>';  

	echo '<tr>
			<td>Media mese del valore nominale di ammissioni nuovi Soci (ultimi 6 mesi, destinati al Fondo)</td>
			<td>Eur ' .number_format($BudgetMensile,0,'','.').'
				&nbsp;&nbsp;&nbsp;&nbsp;<i>(effettivo Eur ' .number_format($ipotesiBudgetMensile,0,'','.').')</i>
			</td></tr>';
