...
// *****************************************************************************
echo '<center>
        <h2><i class="fas fa-check-double fa-1x text-gray-300 col-auto"></i>RICHIESTA ELIMINAZIONE VINCOLO CONTO</h2>';
/*        
...
<br><br>
<form action="segnalazione_mail_vincolo.php" method="POST" onsubmit="return ray.ajax()">
<table border="0" align="center">
    <tr>
        <td align="left" valign="top">
        	<label><small>La ricerca può avvenire per NAG, NOME, NUMERO CONTO</small>
            <div class="form-group">
            <input type="text" class="form-control" id="search-box" name="search-box" placeholder="Socio da scollegare" required>
    ...
    <tr>
        <td>
            <div class="form-group">
              <input type="text" class="form-control" id="note" name="note" placeholder="Indicare qui il NUMERO DI CONTO con il vincolo" >
            </div>
        </td>
    </tr>
    <tr >
...
elseif 
    ($_POST['inviamail'] == "si")
	{
		...
		$mail_oggetto = "Portale Soci - Segnalazione VINCOLO DA ELIMINARE ".$_POST['search-box'];
		...
		$mail_corpo .= "Si richiede di eliminare il vincolo del conto presente sul socio<br> <b style='color:brown;'>".$_POST['search-box']."</b> <br>";
		$mail_corpo .= "Conto nr. ".$_POST['note']." <br>";
		...
		$mail_corpo .= "- - - - - - - - - ";
		$mail_corpo .= "<br>&#128231;&nbsp;<a href=\"mailto:".$mail_mittente."?subject=Eliminazione vincolo avvenuta - ".$_POST['search-box']."&body=Fatto, ciao.\">Invia mail di eseguito</a>";
