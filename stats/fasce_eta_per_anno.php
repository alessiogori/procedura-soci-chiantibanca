...
<center>
<div class="col-lg-12">
  <div class="alert alert-dismissible alert-success"><h3>Fascie di età</h3>
  '.$titolofiliale.'</div>
</div>
';
...
$tab_dettaglioA .= '
      <table class="table table-hover" border="1" valign="top" width="100%" align="center" class="heatmap">
      <thead>
        <tr class="chartResult table-secondary">
          <th align="right" width="12%">Anno Ammissione</td>
          <th align="right" width="12%">18-30 anni (1)</td>
          <th align="right" width="12%">31-50 anni (2)</td>          
          <th align="right" width="12%">51-60 anni (3)</td>          
          <th align="right" width="12%">61-70 anni (4)</td>          
          <th align="right" width="12%">+ 70 anni (5)</td>          
          <th align="right" width="12%">Totale Soci</td>
        </tr>
      </thead>
        <tbody>';
  ...
  while ($row_areeA = mysqli_fetch_array($result_areeA)) {
    ...
    $tab_dettaglioA .=  "<tr  ".$trclass.">
                          <td align='right' width='12%' class='first_row'>&nbsp;".number_format($row_areeA['AnnoAmmissione'],0,',','.')."&nbsp;</td>
                          <td align='right' width='12%' ".$tdclass.">
                            ".number_format($row_areeA['qta_Fascia1'],0,',','.')."</td>
                          <td align='right' width='12%' ".$tdclass.">
                            ".number_format($row_areeA['qta_Fascia2'],0,',','.')."</td>
                          <td align='right' width='12%' ".$tdclass.">
                            ".number_format($row_areeA['qta_Fascia3'],0,',','.')."</td>
                          <td align='right' width='12%' ".$tdclass.">
                            ".number_format($row_areeA['qta_Fascia4'],0,',','.')."</td>
                          <td align='right' width='12%' ".$tdclass.">
                            ".number_format($row_areeA['qta_Fascia5'],0,',','.')."</td>
