...
// per archiazione Isidoc delle singole richieste deliberate come Cessioni Banca
// *****************************************************************************
...
// ---------------------------------------
        ...
        if (mysqli_num_rows($querydati) <= 0) {
            ...
            $contenutoOutput = '';
            $myfileesclusioni = fopen("dmx/cessionibanca_dmx.csv", "w");
            ...
            while($dati=mysqli_fetch_array($querydati)){ 
                ...
                imagegif($image_p, 'dmx/cb_'.$NAG.'.gif');
                imagedestroy($im);
                ...
                echo '<table align="center">
                      <tr>
                        <td align="center" style="size:14px;font-family:verdana;"><b>UFFICIO SOCI - CESSIONE A BANCA - ID ' . $ID . '</b></td>
                      </tr>
                      <tr>
                        <td style="size:12px;font-family:verdana;">' . $NAG . ' - ' .  $Nominativo . '</td>
                      </tr>
                      <tr>
                        <td align="center">' . '<img src="dmx/cb_'.$NAG.'.gif' . '" height="300"></td>
                      </tr>
                      <tr>
                        <td style="size:12px;font-family:verdana;">' . $NAG . ' - ' .  $Nominativo . '</td>
                      </tr>
                      <tr>
                        <td style="size:12px;font-family:verdana;">Richiesta del ' . $dati['Data_Richiesta'] . ' (' . $dati['Totale_Parziale'] . ')</td>
                      </tr>
                      <tr>
                        <td style="size:12px;font-family:verdana;">Note : ' . $dati['Note_Motivazioni'] . '</td>
                      </tr>
                      </table>'  ;
...
echo '  <fieldset style="width:700px;text-align:left;"">
        <legend>&nbsp; Creazione Frontespizi Datamatrix <b>Cessioni a Banca</b></legend>';
echo '
    <form action="'.$_SERVER['PHP_SELF'].'" method="GET" onsubmit="return ray.ajax()"><table border="0" align="center" cellpadding="0" cellspacing="0" width="100%" >
                ...
                <input type="text" name="idlist" size="20">&nbsp;Numeri ID separati da virgola<br>
