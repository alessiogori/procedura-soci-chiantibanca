...
header("Content-Disposition: attachment; Filename=SO07.doc");
...
<tr>
    <td width="10%" align="left" style="font-size:14px;font-family:Verdana;">SO07</td>
    <td width="80%" align="center" style="font-family:Verdana;"><h3>DOMANDA DI INTESTAZIONE AZIONI AGLI EREDI</h1></td>
    <td width="10%">&nbsp;</td>    
</tr>
</table>
...
<br>
in esecuzione della divisione ereditaria concordata di intestare le azioni suddette a nome di 
<br>
<br><?php echo '<b>[NOMINATIVO EREDE DESIGNATO]</b>'; ?><br>nato/a a <?php echo '[LUOGO DI NASCITA EREDE DESIGNATO]'; ?> il <?php echo '[DATA DI NASCITA EREDE DESIGNATO]'; ?>, residente in <?php echo '[RESIDENZA EREDE DESIGNATO]'; ?>

<br>
<br>
Il nominativo indicato dichiara di <br>
[   ] essere Socio di ChiantiBanca <br>
[   ] aver presentato domanda di ammissione a Socio di ChiantiBanca (che si allega alla presente)
<br>
<br>
...
//echo 'http://10.119.192.46:8080/soci/modulistica/test.php?modello=SO07&cag=03033148&socio=FEDI+ALESSIO+&idsocio=3060086&luogo=Pistoia';
...
echo '  <fieldset style="width:700px;text-align:left;"">
        <legend>&nbsp; Definizione della <b>INTESTAZIONE A EREDI (SO07)</b> <br>&nbsp; Cag '.$_GET['cag'].' <b>'.$_GET['socio'].'</b><i>(deceduto)</i></legend>';
echo '
