...
-->
  ...
  <table border="0" align="center" width="98%">
    <tr>
      <td align="left" width="70%"><a class="nav-link" style="text-decoration: none;" href="/soci/index.php"><img src="img/logo_chiantibanca.png" height="60"></a></td>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <a style="text-decoration: none;" href="/soci/index.php"><i class="fas fa-home fa-2x text-gray-300 col-auto"></i><span class="navbar-brand mb-0 h1"><b>&nbsp;PORTALE SOCI</b></span></a>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav bd-navbar-nav flex-row">
      ...
      <li class="nav-item active">
        <a class="nav-link" style="text-decoration: none;" href="/soci/index.php">Home <span class="sr-only">(current)</span></a>
      </li>
    -->
      <li class="nav-item">
        <a class="nav-link" style="text-decoration: none;" href="/soci/faq/?qa=questions" target="_blank">FAQ</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" style="text-decoration: none;" href="/soci/documentazione.php">Documentazione</a>
      </li>
<!--  <li class="nav-item">
        <a class="nav-link" style="text-decoration: none;" href="/soci/modulistica.php">Modulistica</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" style="text-decoration: none;" href="/soci/suggest.php">Comunicazioni</a>
      </li> -->
      <li class="nav-item">
        <a class="nav-link" style="text-decoration: none;" href="/soci/filiale_auth.php">&reg;Filiale</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" style="text-decoration: none;" href="/soci/area_auth.php">&reg;Area</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" style="text-decoration: none;" href="/soci/direzione_auth.php">&reg;Direzione</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" style="text-decoration: none;" href="/soci/soci_auth.php">&reg;Soci</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" style="text-decoration: none;" href="/soci/admin.php">&reg;Admin</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" style="text-decoration: none;" href="/soci/docs/PortaleSoci.pdf">?</a>
      </li>
    </ul>
...
-->
      <a class="nav-link" style="text-decoration: none;" href="/soci/segnalazione_mail_decesso.php" title="Segnalazione Decesso Socio"><i class="fas fa-cross fa-1x text-gray-300 col-auto"></i></a>

      <a class="nav-link" style="text-decoration: none;" href="/soci/segnalazione_mail_vincolo.php" title="Richiesta eliminazione Vincolo Conto"><i class="fas fa-check-double fa-1x text-gray-300 col-auto"></i></a>

      <a class="nav-link" style="text-decoration: none;" href="/soci/segnalazione_mail_scissione.php" title="Richiesta Scissione Certificati"><i class="fas fa-cut fa-1x text-gray-300 col-auto"></i></a>

      <a class="nav-link" style="text-decoration: none;" href="/soci/bday.php?key=<?php echo $filiale_id;?>" title="Compleanno Soci"><i class="fas fa-birthday-cake fa-1x text-gray-300 col-auto"></i></a>
