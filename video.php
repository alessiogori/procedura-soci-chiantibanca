...
<div class="row">	
              ...
              <div class="card border-success mb-6">
                ...
                <div class="card-body">
                    <video width="300" controls>
                        <source src="http://10.197.139.22:8080/soci/video/00_intro.mp4" type="video/mp4">
                    </video>
             </div>
              </div>
            </div>
            ...
            <div class="col-lg-3">
              <div class="card border-success mb-6">
                ...
                <div class="card-body">
                    <video width="300" controls>
                        <source src="http://10.197.139.22:8080/soci/video/01_ricercasocio.mp4" type="video/mp4">
                    </video>
             </div>
              </div>
            </div>
            ...
            <div class="col-lg-3">
              <div class="card border-success mb-6">
                ...
                <div class="card-body">
                    <video width="300" controls>
                        <source src="http://10.197.139.22:8080/soci/video/02_schedasocio.mp4" type="video/mp4">
                    </video>
             </div>
              </div>
            </div>            
            ...
            <div class="col-lg-3">
              <div class="card border-success mb-6">
                ...
                <div class="card-body">
                    <video width="300" controls>
                        <source src="http://10.197.139.22:8080/soci/video/03_esclusione.mp4" type="video/mp4">
                    </video>
             </div>
              </div>
            </div>  
...
<div class="row">	
            ...
            <div class="col-lg-3">
              <div class="card border-success mb-6">
                ...
                <div class="card-body">
                    <video width="300" controls>
                        <source src="http://10.197.139.22:8080/soci/video/04_decesso.mp4" type="video/mp4">
                    </video>
             </div>
              </div>
            </div>
            ...
            <div class="col-lg-3">
              <div class="card border-success mb-6">
                ...
                <div class="card-body">
                    <video width="300" controls>
                        <source src="http://10.197.139.22:8080/soci/video/05_rateizzazione.mp4" type="video/mp4">
                    </video>
             </div>
              </div>
            </div>
            ...
            <div class="col-lg-3">
              <div class="card border-success mb-6">
                ...
                <div class="card-body">
                    <video width="300" controls>
                        <source src="http://10.197.139.22:8080/soci/video/06_faq.mp4" type="video/mp4">
                    </video>
             </div>
              </div>
            </div>            
            ...
            <div class="col-lg-3">
              <div class="card border-success mb-6">
                ...
                <div class="card-body">
                    <video width="300" controls>
                        <source src="http://10.197.139.22:8080/soci/video/07_documentazione.mp4" type="video/mp4">
                    </video>
             </div>
              </div>
            </div>  
...
<div class="row">	
            ...
            <div class="col-lg-3">
              <div class="card border-success mb-6">
                ...
                <div class="card-body">
                    <video width="300" controls>
                        <source src="http://10.197.139.22:8080/soci/video/08_filiale_parte1.mp4" type="video/mp4">
                    </video>
             </div>
              </div>
            </div>
            ...
            <div class="col-lg-3">
              <div class="card border-success mb-6">
                ...
                <div class="card-body">
                    <video width="300" controls>
                        <source src="http://10.197.139.22:8080/soci/video/09_filiale_parte2.mp4" type="video/mp4">
                    </video>
             </div>
              </div>
            </div>
            ...
            <div class="col-lg-3">
              <div class="card border-success mb-6">
                ...
                <div class="card-body">
                    <video width="300" controls>
                        <source src="http://10.197.139.22:8080/soci/video/as00_raccoltadeleghe.mp4" type="video/mp4">
                    </video>
             </div>
              </div>
            </div>
...
<object classid="clsid:22D6F312-B0F6-11D0-94AB-0080C74C7E95" width="700"
   ...
   <param name="Filename" value="http://10.197.139.22:8080/soci/video/prova_audiopc.wmv">
   ...
   <embed src="http://10.197.139.22:8080/soci/video/prova_audiopc.wmv"
