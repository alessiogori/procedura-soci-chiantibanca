...
if ($_GET['segnalazione'] == 'vincolo')
	{$condizione = '';}

if ($_GET['segnalazione'] == 'decesso')
	{$condizione = "AND TIPO_NAG = 'PF' ";}
...
$query ="   SELECT NAG, CONCAT(INTESTAZIONE_A,' ',INTESTAZIONE_B) as NOMINATIVO, DATA_NASCITA, 
			case 
				...
				END as STATO,
			IDSOCIO, DATA_DECESSO, NUM_RAPP
            FROM sds_soci 
            WHERE CONCAT(INTESTAZIONE_A,' ',INTESTAZIONE_B) like '" . $_POST["keyword"] . "%' 
            OR NAG  like '" . $_POST["keyword"] . "%' 
            OR NUM_RAPP  like '" . $_POST["keyword"] . "%' 
            ".$condizione."
