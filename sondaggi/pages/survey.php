	...
	if(isset($_REQUEST["proceed_submit"]))
	{
		...
		else
		{
			...
			foreach($s_questions as $question)
			{
				...
				if(isset($_POST["survey_question_".$question_counter])&&is_array($_POST["survey_question_".$question_counter]))
				{
					$_POST["survey_question_".$question_counter]=implode(", ",$_POST["survey_question_".$question_counter]);
				}
