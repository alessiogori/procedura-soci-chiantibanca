To install PHP Survey on your website, you just need
to unzip PHPSurvey.zip and copy the files to your preferred folder.
...
www.yourdomain.com/surveys

then the administration panel will be available on:

www.yourdomain.com/surveys/admin
username: administrator
password: abc123

Please note that you are required to keep the Powered By link at the bottom of the site.
If you prefer The Powered By link to be removed, this can be done for $39 one-time fee (we can also do a free installation on your server / hosting package in such case).
