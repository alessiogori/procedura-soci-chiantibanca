...
$titolo  = "Caricamento SOCI - XLS AS37";
$tabella = "tab_soci_as37";
$nomefile= "DATISOCI.csv";
$istruzioni = '	1. Esegui tramite transazione <b>AS37</b><br>
                2. Recupera il file DATISOCI.CSV dal disco di spool P\SOCI\OUTPUT <br>
                3. Esegui la macro del file O:\COMUNITY BANKING\_Dati\_AS37_DatiSoci_SCHEMAxDB.xlsm (clicca pulsante blu) <br>
                4. Conferma il salvataggio in sovrascrittura su _AS37_DatiSoci.xlsx <br>
				5. Carica il file DATISOCI.CSV su questa pagina (sfoglia...)<br>
