...
$titolo  = "Caricamento FILE GENERICO (da adattare)";
$tabella = "tab_mutua_raccordo";      // NOME TABELLA DA ADATTARE
$nomefile= "Generico.csv";
$istruzioni = '	1. Caricalo su questa pagina (sfoglia...)<br>
                <br>
				';
...
<table align="center" border="0" width="80%">
    <tr><td>
<form enctype="multipart/form-data" class="form-horizontal" action="csv2sql_generico.php" method="post">  
