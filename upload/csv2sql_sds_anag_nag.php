...
$titolo  = "Caricamento SOCI - SADAS Tabella ANAG_NAG";
$tabella = "sds_anag_nag";
$nomefile= "sds_anag_nag.csv";
$istruzioni = '	1. Apri <b>DbQuery</b> (Sicra > Sistemi Guida) <br>
                2. Apri da Richieste Private > <b>Soci > Portale Soci > PS_AnagNag</b> <br>
                3. Esegui la ricerca <br>
                5. Scarica il file in formato CSV (tutti i records) e salvalo con nome <b>sds_anag_nag.csv</b> <br>
				6. Carica il file <b>sds_anag_nag.csv</b> su questa pagina (sfoglia...)<br>
    ...
    while($data=fgetcsv($handler, 0, ';')){
        ...
        mysqli_query($cons, "INSERT INTO ".$table." 
                             ...
                             (
                                ...
                                '".mysqli_real_escape_string($cons, $data[5])."',
                                '".mysqli_real_escape_string($cons, $data[6])."',
                                '".mysqli_real_escape_string($cons, $data[7])."',
                                '".mysqli_real_escape_string($cons, $data[8])."',
                                '".mysqli_real_escape_string($cons, $data[9])."',
                                '".mysqli_real_escape_string($cons, $data[10])."',
                                ...
                                '".mysqli_real_escape_string($cons, $data[19])."',
                                '".mysqli_real_escape_string($cons, $data[20])."',
                                '".mysqli_real_escape_string($cons, $data[21])."',
                                '".mysqli_real_escape_string($cons, $data[22])."',
                                '".mysqli_real_escape_string($cons, $data[23])."',
                                '".mysqli_real_escape_string($cons, $data[24])."',
                                '".mysqli_real_escape_string($cons, $data[25])."',
                                '".mysqli_real_escape_string($cons, $data[26])."',
                                ...
                                '".mysqli_real_escape_string($cons, $data[35])."',
                                ...
                                '".mysqli_real_escape_string($cons, $data[53])."',
                                ...
                                '".mysqli_real_escape_string($cons, $data[63])."',
