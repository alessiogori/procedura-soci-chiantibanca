...
$titolo  = "Caricamento SOCI - XLS Decessi-Eredi";
$tabella = "tab_xls_decessi_eredi";
$nomefile= "Decessi-Eredi.csv";
$istruzioni = '	1. Esegui tramite apposita macro l\'esportazione del foglio Decessi-Eredi nel file Excel CDA_ELENCO<br>
