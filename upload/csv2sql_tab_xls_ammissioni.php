...
$titolo  = "Caricamento SOCI - XLS Ammissioni";
$tabella = "tab_xls_ammissioni";
$nomefile= "Ammissioni.csv";
$istruzioni = '	1. Esegui tramite apposita macro l\'esportazione del foglio Ammissioni nel file Excel CDA_ELENCO<br>
